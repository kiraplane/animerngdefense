...
export const CANONICAL_BASE_URL = 'https://www.animerngdefense.site';
...
function getAnimeRngDefenseBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'animerngdefense.site' ||
      parsedUrl.hostname === 'www.animerngdefense.site'
    ) {
...
export function getBaseUrl(): string {
  ...
  const animeRngDefenseBaseUrl = getAnimeRngDefenseBaseUrl(configuredBaseUrl);
  if (animeRngDefenseBaseUrl) {
    return animeRngDefenseBaseUrl;
  }
