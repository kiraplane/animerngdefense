...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Thanos Simulator Wiki Disclaimer',
    description:
      'Thanos Simulator Wiki disclaimer covering independent guide status, Roblox source handling, codes, scripts, updates, and safety boundaries.',
    locale,
    pathname: '/disclaimer',
      ...
      <Container className="space-y-8 px-4">
        <header className="max-w-3xl space-y-4">
          ...
          <h1 className="font-display text-4xl font-black md:text-6xl">
            Thanos Simulator Wiki Disclaimer
          </h1>
          <p className="text-[#C6BCD8] text-lg leading-8">
            Thanos Simulator Wiki is an independent guide site for Roblox
            players. It is not created, endorsed, sponsored, or operated by
            Roblox, Marvel, Disney, {officialGameFacts.creatorName}, or the
        ...
        <section className="rounded-lg border border-[#3A2D4E] bg-[#151024] p-6 text-[#C6BCD8] leading-8">
          ...
          <p className="mt-3">
            ...
            details can change after updates, especially around new content such
            as Doom and Mechanical Gloves.
          </p>
          <h2 className="mt-8 font-display text-2xl font-bold text-[#F8F1FF]">
            Codes and updates
          </h2>
          <p className="mt-3">
            Thanos Simulator can change without notice. Codes can appear,
            expire, or never exist despite search demand. This wiki does not
            list a code as active unless it is tied to this exact Roblox
            experience and backed by reliable current evidence.
          </p>
          <h2 className="mt-8 font-display text-2xl font-bold text-[#F8F1FF]">
            Safety boundary
          </h2>
