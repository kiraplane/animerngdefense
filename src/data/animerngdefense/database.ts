...
export const rewardItems: RewardEntry[] = [
  ...
  },
  {
    ...
    id: 'cursed-fingers',
    name: 'Cursed Fingers',
    category: 'Legacy JJK update item',
    stage: 'Update',
    role: 'Event/update reward',
    summary:
      'Cursed Fingers belong to the earlier JJK update cycle and remain useful only when an older code still redeems or the live UI still requests them.',
...
export const mapRoutes: MapEntry[] = [
  ...
  },
  {
    kind: 'map',
    id: 'update-map',
    name: 'Fairy Forest Update Map',
    category: 'Update maps',
    stage: 'Update',
    purpose:
      'Track the newest world without mixing legacy JJK data into the current route.',
    summary:
      'The official description publishes FairyForest as the current code and the 7DS title tag confirms a new cycle. Use Fairy Forest as a live-check route while exact waves and drops remain unverified.',
    prerequisites: ['Update page checked', 'Current codes redeemed'],
    keyObjectives: [
      'Check Roblox title and description.',
      'Redeem FairyForest before the first repeatable baseline run.',
    ...
    relatedRoutes: ['/updates', '/guides/jjk-update-guide', '/codes'],
    relatedEntities: ['Fairy Forest', '7DS update', 'FairyForest'],
    sourcePages: ['Roblox official title', 'Current code trackers'],
    confidence: 'watch',
  },
];
