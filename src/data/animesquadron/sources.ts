...
export const sources = {
  ...
  beebomCodes: {
    ...
    confidence: 'medium',
    note: 'Rechecked June 22, 2026. Used as a code and redeem-flow cross-check for the UPD 0.5 code wave, not copied as article prose.',
  },
  destructoidCodes: {
    type: 'guide_site',
    ...
    checkedAt: '2026-06-22',
    confidence: 'medium',
    note: 'Rechecked June 22, 2026. Used for active-code overlap, inactive-code checks, and community-link caution.',
  },
  proGameGuidesCodes: {
    type: 'guide_site',
    ...
    checkedAt: '2026-06-22',
    confidence: 'medium',
    note: 'Rechecked June 22, 2026. Used for active-code overlap, inactive-code checks, and launch-stage search demand.',
  },
  pcgamesnCodes: {
    type: 'guide_site',
  ...
  proGameGuidesTierList: {
    ...
    checkedAt: '2026-06-19',
    confidence: 'medium',
    note: 'Used to cross-check named units, role notes, obtainment notes, and current meta framing.',
  },
  destructoidTierList: {
    type: 'guide_site',
    label: 'Destructoid Anime Squadron tier list',
    url: 'https://www.destructoid.com/anime-squadron-tier-list-best-units-ranked/',
    checkedAt: '2026-06-19',
    confidence: 'medium',
    note: 'Used to cross-check top-meta unit names and role descriptions against other guide sites.',
  },
  sportskeedaTierList: {
    type: 'guide_site',
